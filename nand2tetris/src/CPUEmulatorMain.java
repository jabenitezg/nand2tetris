  ...
  public static void main(String[] args) {
        if (args.length > 1)
            ...
            CPUEmulatorApplication application =
                new CPUEmulatorApplication(controllerGUI, simulatorGUI, InstallDir + "bin/scripts/defaultCPU.txt",
                		InstallDir + "bin/help/cpuUsage.html", InstallDir + "bin/help/cpuAbout.html");
        }
        else
